    ...
    <AuthenticatedLayout>
        ...
        <div class="mb-4 inline-flex w-full overflow-hidden rounded-lg bg-white shadow-md">
            ...
            <div class="-mx-3 px-4 py-2">
                <div class="mx-3">
                    <button type="button" class="font-semibold text-blue-500">Add new member</button>
                </div>
            </div>
        </div>
                ...
                <tbody>
                    <tr v-for="player in players.data" :key="player.id" class="text-gray-700">
                        <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">{{ player.firstname }} {{ player.lastname }}</p>
                        </td>
                        <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">{{ player.email }}</p>
                        </td>
                        <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">{{ player.birthdate }}</p>
                        </td>
                        <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">{{ player.phone }}</p>
                        </td>
                        <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                            <button type="button" class="btn bg-sky-500 text-gray-100 p-3 mx-3">View</button>
                            <button type="button" class="btn bg-green-500 text-gray-100 p-3 mx-3">Edit</button>
                            <button type="button" class="btn bg-red-500 text-gray-100 p-3 mx-3">Delete</button>
                        </td>
                    </tr>
                </tbody>
            </table>
